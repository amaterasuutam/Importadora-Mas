      ...
      <header className="sticky top-0 z-30 border-b border-[#ebe5dc] bg-[#fbfaf7]/95 backdrop-blur-md">
        <div className="container-shop flex h-[74px] items-center gap-4">
          ...
          <a data-testid="link-home" href="#inicio" className="flex items-center gap-2.5 shrink-0">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#c9362b] font-display text-xl font-bold tracking-[-.15em] text-white">IM</span>
            <span className="hidden xs:block leading-none"><strong className="block font-display text-[17px] tracking-tight">IMPORTADORA</strong><small className="text-[10px] font-semibold tracking-[.23em] text-[#c9362b]">MÁS · LINARES</small></span>
          </a>
